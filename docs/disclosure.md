...
**`D-15` is now the most serious item here, and `D-4`, `D-11` and `D-12` are next**, and **none** has had
the per-handler prior-art search that step 2 of the procedure below requires. The
